...
import { AbstractToolbarEntryDirective } from '@components/pages/editor/toolbar/abstract-toolbar-entry/abstract-toolbar-entry';
...
export class EraserToolbarComponent extends AbstractToolbarEntryDirective<EraserToolProperties> {
