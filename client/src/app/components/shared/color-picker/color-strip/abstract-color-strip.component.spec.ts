...
describe('AbstractColorStripComponent', () => {
  @Directive()
  class AbstractColorStripComponentImpl extends AbstractColorStripDirective {
    get value(): number {
      return 0;
    }
  ...
  const component: AbstractColorStripDirective = new AbstractColorStripComponentImpl();
